...
namespace QQMusicDecryptRunner
{
    ...
    internal static class Program
    {
        ...
        {
#if MICROSOFTSTORE
            string pipeName = @"LOCAL\QQMusicDecrypt_" + Guid.NewGuid().ToString("N");
#else
        ...
        private static Process LaunchAndWaitForReady(string exePath)
        {
            ...
            {
                Console.WriteLine("LOG|QQ Music hidden launch failed: " + exception.Message
                    + " Falling back to shell launch.");
